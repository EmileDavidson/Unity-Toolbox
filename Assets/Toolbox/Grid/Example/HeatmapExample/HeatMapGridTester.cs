...
namespace Toolbox.Grid.Example.HeatmapExample
{
    public class HeatMapGridTester : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ICell heat = GridHeatmapHandler.Instance.GetCell<HeatMapCellObject>(0, 0);
            ...
            IHeatMapCell otherHeat = GridHeatmapHandler.Instance.GetHeatCell<HeatMapCellObject>(0,0);
            print(otherHeat);
        }
    }
}
